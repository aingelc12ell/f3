...
abstract class Cursor extends \Magic implements \IteratorAggregate {
	...
	*	@param $ttl int
	**/
	abstract function find($filter=NULL,array|NULL $options=NULL,$ttl=0);
	...
	*	@param $ttl int
	**/
	abstract function count($filter=NULL,array|NULL $options=NULL,$ttl=0);
	...
	*	@param $ttl int
	**/
	function findone($filter=NULL,array|NULL $options=NULL,$ttl=0) {
		if (!$options)
			$options=[];
		// Override limit
		$options['limit']=1;
	...
	**/
	function paginate(
		$pos=0,$size=10,$filter=NULL,array|NULL $options=NULL,$ttl=0,$bounce=TRUE) {
	...
	*	@param $ttl int
	**/
	function load($filter=NULL,array|NULL $options=NULL,$ttl=0) {
		$this->reset();
